//! Filesystem utilities: path normalization, relative path computation, and output
//! directory management for the dist/ folder.
...
pub fn create_output_directories(output_dir: &Path) -> Result<()> {
    for dir in crate::dependency_graph::TargetLocation::all_dir_names() {
