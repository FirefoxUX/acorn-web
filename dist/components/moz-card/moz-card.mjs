...
export default class MozCard extends MozLitElement {
  ...
  headingTemplate() {
    ...
    return html`
      <div id="heading-wrapper" part="moz-card-heading-wrapper">
        ${when(this.type == "accordion", () => html`<div class="chevron-icon"></div>`)}
        ${when(!!this.iconSrc, () => html`<acorn-icon
              id="heading-icon"
              src=${this.iconSrc}
  ...
  static styles = [...MozLitElement.styles ?? [], css`/* From chrome://global/content/elements/moz-card.css */
:host {
...
#heading-wrapper {
  ...
  & .chevron-icon {
    -webkit-mask-image: var(--card-accordion-closed-icon, url("../../assets/arrow-down.svg"));

    mask-image: var(--card-accordion-closed-icon, url("../../assets/arrow-down.svg"));

    details[open] & {
      -webkit-mask-image: var(--card-accordion-open-icon, url("../../assets/arrow-up.svg"));

      mask-image: var(--card-accordion-open-icon, url("../../assets/arrow-up.svg"));
    }
  }
  ...
  & .chevron-icon, & #heading-icon {color: currentColor;
    width: var(--icon-size);
...
if (!customElements.get("moz-card")) { customElements.define("moz-card", MozCard); }
