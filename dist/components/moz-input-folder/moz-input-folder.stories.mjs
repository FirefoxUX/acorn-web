...
const Template = ({ name, value, iconSrc, disabled, l10nId, description, supportPage, hasSlottedDescription, hasSlottedSupportLink, ellipsized, hasAdditionalAction }) => html`
  ...
  capture: true
    ...
    >
      ...
      ${hasAdditionalAction ? html`<moz-button
            slot="actions"
